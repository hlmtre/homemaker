//! hm provides a library to do basic filesystem operations that you'd want a dotfile
//! manager to do (like symlink). Also provides functionality to thread off heavier
//! operations into task threads, which will regularly report back their status with
